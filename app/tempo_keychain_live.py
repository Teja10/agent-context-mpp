"""Production Tempo Keychain implementation backed by a Tempo RPC via web3.

Verification of each charge reuses the same on-chain Transfer-log shape that
``mpp.methods.tempo.ChargeIntent`` already validates.
"""
...
from pytempo import ACCOUNT_KEYCHAIN_ADDRESS, TempoTransaction
